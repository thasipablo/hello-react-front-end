...
[This is the link of the backend application](https://github.com/thasipablo/hello-rails-back-end)
...
```sh
  git git@github.com:thasipablo/hello-react-front-end.git
...
- LinkedIn: [thasipablo](https://www.linkedin.com/in/nessrine-macherki-86959196/)
...
Feel free to check the [issues page](https://github.com/thasipablo/hello-react-front-end/issues).
